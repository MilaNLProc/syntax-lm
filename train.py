...
from syntax_lm import SyntaxLMSequenceClassification
...
def main():
    ...
    parser.add_argument("--use_syntax", action="store_true")
    ...
    def preprocess_function(examples):
        ...
        # Tokenize the texts
        parse1 = dependency_parser.parsing(
            examples[sentence1_key], max_length=max_length
        )
        parse2 = parse1
        if sentence2_key is not None:
            parse2 = dependency_parser.parsing(
                examples[sentence2_key], max_length=max_length
            )
        ...
        args = (
            ...
            else (parse1["words"], parse2["words"])
        )
        result = tokenizer(
            *args,
            padding="max_length",
        ...
        out_map = dependency_parser.map_tokens(
